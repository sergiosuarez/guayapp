...
<script type="text/javascript" src="../../js/evento/f_evento.js"></script>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="evento.php"><b>Registros</b></a></li>
	</ul>
	</div>
	<div id="rightContent">
	<h3>Nuevo Evento</h3>
		<table width="95%">
                       <form id="form_ingre_info" method="GET" action="" onsubmit="return false">
                            <tr>
                                ...
                                <td><textarea id="texta_descripcion" ></textarea></td>
                            </tr>

                            <tr>
                                <td><b>Tipo:</b></td>
                                <td>
                                    <select id=cmb_tipo_eventos">
                            ...
                            <tr>
                                <td><b>Hora: </b></td>
                                <td>
                                    <input type="text" id=txt_hora" /> (00h00)
                                </td>
                            </tr>
