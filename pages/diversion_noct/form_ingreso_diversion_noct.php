<html>
<head>
<title>Ingreso de Diversión Nocturna</title>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="diversion_noct.php"><b>Registros</b></a></li>
	</ul>
	</div>
	<div id="rightContent">
	<h3>Nueva Diversión Nocturna</h3>
		<table width="95%">
                       <form id="form_ingre_info" method="GET" action="" onsubmit="return false">
                            ...
                            <tr>
                                <td><b>Tipo:</b></td>
                                <td>
                                    <select id="cmb_tipo_diversion_noct">
