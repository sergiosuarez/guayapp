<html>
<head>
<title>Ingreso de Alojamientos</title>
...
<script type="text/javascript" src="../../js/gastronomia/f_gastronomia.js"></script>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="gastronomia.php"><b>Registros</b></a></li>
	</ul>
	</div>
	<div id="rightContent">
	<h3>Nueva Gastronomia</h3>
		<table width="95%">
                       <form id="form_ingre_info" method="GET" action="" onsubmit="return false">
                            ...
                            <tr>
                                <td><b>Tipo:</b></td>
                                <td>
                                    <select id="cmb_tipo_gastronomia">
                            ...
                            <tr>
                                <td><b>Lugar:</b></td>
                                <td><textarea id="txta_lugar" ></textarea></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <input id="btn_abrir_pop_up_subir_img" type="button" class="button" value="Subir Imagen" >
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Página web(link):</b></td>
                                <td><input type="text" id="txt_pag_web" size="30" value="www.pagweb.com"/></td>
                            </tr>
