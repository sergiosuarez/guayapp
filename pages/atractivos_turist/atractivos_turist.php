...
<html>
<head>
<title>Administración - Sección Atractivos Turísticos</title>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="form_ingreso_atractivos_turist.php"><b>Nuevo</b></a></li>
		<!--<li><a href="tabel.html">Tabel</a></li>
		<li><a href="form.html">Form</a></li>-->
	</ul>
	</div>
	<div id="rightContent">
	<h3>Sección Atractivos turísticos</h3>
