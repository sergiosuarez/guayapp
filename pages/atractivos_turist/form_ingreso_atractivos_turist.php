<html>
<head>
<title>Ingreso de Atractivos Turísticos</title>
...
<script type="text/javascript" src="../../js/atractivos_turisticos/f_atract_turistic.js"></script>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="atractivos_turist.php"><b>Registros</b></a></li>
	</ul>
	</div>
	<div id="rightContent">
	<h3>Nuevo Atractivo Turístico</h3>
		<table width="95%">
                       <form id="form_ingre_info" method="GET" action="" onsubmit="return false">
                            <tr>
                                <td><b>Descripción:</b></td>
                                <td><textarea id="descrip_atract_turistic" ></textarea></td>
                            </tr>

                            <tr>
                                <td><b>Tipo:</b></td>
                                <td>
                                    <select id="tipo_atract_turistic">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <input id="btn_abrir_pop_up_subir_img" type="button" class="button" value="Añadir Imagen" >
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <input id="btn_abrir_pop_up_ubica_geo" type="button" class="button" value="Ubicación geográfica">
                                </td>
                            </tr>
        ...
        <div>
                ...
                <div class="informacion" > <br />El archivo a subir debe tener formato .PNG .JPG.</div>
                  <div class='contenido_centrado'>
                    <a href='#' class='button_upload upload_icon' id="btn_enviar_img" name='archivo' ><b>Subir imagen</b></a>
  ...
  <!-- ////////////// Pop up ubicar geograficamente ///////////////////-->
   <div id='ventana_ubicacion_geografica' class="windowUnload">
        ...
        <!--<div>-->
                ...
                <div class='contenido_centrado'>
                    <a href='#' class='button' id="btn_guardar_ubica_geo" ><b>Aceptar</b></a>
