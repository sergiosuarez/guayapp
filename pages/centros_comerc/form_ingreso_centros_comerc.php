<html>
<head>
<title>Ingreso de Centros Comerciales</title>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="centros_comerc.php"><b>Registros</b></a></li>
	</ul>
	</div>
	<div id="rightContent">
	<h3>Nuevo Centro Comercial</h3>
		<table width="95%">
                       <form id="form_ingre_info" method="GET" action="" onsubmit="return false">
                            <tr>
                                <td><b>Descripción:</b></td>
                                <td><textarea id="txt_descrip" ></textarea></td>
                            </tr>

                            <tr>
                                <td><b>Tipo:</b></td>
                                <td>
                                    <select id="cmb_tipo_centro_comerc">
