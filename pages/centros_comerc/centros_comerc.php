...
<html>
<head>
<title>Administración - Sección Alojamientos</title>
...
<script type="text/javascript" src="../../js/centros_comerc/f_centros_comerc.js"></script>
...
<div id="wrapper">
	<div id="leftBar">
	<ul>
		<li><a href="form_ingreso_centros_comerc.php"><b>Nuevo</b></a></li>
		<!--<li><a href="tabel.html">Tabel</a></li>
		<li><a href="form.html">Form</a></li>-->
	</ul>
	</div>
	<div id="rightContent">
	<h3>Sección Alojamientos</h3>
